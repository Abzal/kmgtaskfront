...
<script>
    ...
    export default {
        ...
        watch: {
            ...
            payload: {
                handler() {
                    ...
                    this.pieChartOptions.plugins.title.text = `Общий дебит нефти: ${this.getTotalOilRate()}`;
                },
                deep: true
            }
        },
        methods: {
                    ...
                    datasets: [
                        {
                            ...
                            backgroundColor: this.payload.map(() => this.getRandomColor()),
            ...
            getTotalOilRate() {
                return this.payload.reduce((total, item) => total + item.oil_rate, 0);
            },
            getRandomColor() {
